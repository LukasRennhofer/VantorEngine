...
namespace vantor::Graphics
{
    ...
    class Terrain : public drawableObject
    {
        public:
            ...
            // Model * planeModel;
            vantor::Graphics::Water *waterPtr;
            ...
            void setGrassCoverage(float gc) { grassCoverage = gc; }
        ...
        private:
            ...
            void setPos(int row, int col, glm::vec2 pos) { positionVec[col + row * gridLength] = pos; }

            glm::vec2 getPos(int row, int col) { return positionVec[col + row * gridLength]; }
