    ...
    class LightException : public QuarkException {
      ...
      class Light {
       ...
       protected:
        ...
        virtual void updateUniforms(chif::Graphics::Renderer::Shader::Shader& shader) = 0;
      ...
      class LightRegistry : public UniformSource {
       public:
        ...
        void updateUniforms(chif::Graphics::Renderer::Shader::Shader& shader);
      ...
      class SpotLight : public Light {
       ...
       protected:
        std::string getUniformName(unsigned int lightIdx) const {
          return "chif_spotLights[" + std::to_string(lightIdx) + "]";
        }
        void updateUniforms(chif::Graphics::Renderer::Shader::Shader& shader);
        void applyViewTransform(const glm::mat4& view);
