...
namespace chif::Graphics::Light {
    void LightRegistry::addLight(std::shared_ptr<Light> light) {
      ...
      void LightRegistry::updateUniforms(chif::Graphics::Renderer::Shader::Shader& shader) {
        if (viewSource_ != nullptr) {
          applyViewTransform(viewSource_->getViewTransform());
        }
        shader.setInt("chif_directionalLightCount", directionalCount_);
        shader.setInt("chif_pointLightCount", pointCount_);
        shader.setInt("chif_spotLightCount", spotCount_);
      ...
      void DirectionalLight::updateUniforms(chif::Graphics::Renderer::Shader::Shader& shader) {
        checkState();
      ...
      void PointLight::updateUniforms(chif::Graphics::Renderer::Shader::Shader& shader) {
        checkState();
      ...
      void SpotLight::updateUniforms(chif::Graphics::Renderer::Shader::Shader& shader) {
        checkState();
