...
namespace vantor::Graphics::RenderDevice::OpenGL
{
    ...
    Material* MaterialLibrary::CreateMaterial(std::string base)
    {
        ...
        {
            vantor::Backlog::Log("OpenGLMaterialLibrary", "Material of template: " + base + " requested, but template did not exist.", vantor::Backlog::LogLevel::WARNING);
            return nullptr;
        }
    }
    // --------------------------------------------------------------------------------------------
    ...
    void MaterialLibrary::generateDefaultMaterials()
    {
        ...
        // glass material
        Shader* glassShader = vantor::Resources::LoadShader("glass", "res/intern/shaders/forward_render.vs", "res/intern/shaders/forward_render.fs", { "ALPHA_BLEND" });
        glassShader->Use();
        ...
        Shader* alphaBlendShader = vantor::Resources::LoadShader("alpha blend", "res/intern/shaders/forward_render.vs", "res/intern/shaders/forward_render.fs", { "ALPHA_BLEND" });
        ...
        Shader* alphaDiscardShader = vantor::Resources::LoadShader("alpha discard", "res/intern/shaders/forward_render.vs", "res/intern/shaders/forward_render.fs", { "ALPHA_DISCARD" });
    ...
    void MaterialLibrary::generateInternalMaterials(RenderTarget *gBuffer)
    {
        ...
        // deferred
        deferredAmbientShader     = vantor::Resources::LoadShader("deferred ambient", "res/intern/shaders/deferred/screen_ambient.vs", "res/intern/shaders/deferred/ambient.fs");
        deferredIrradianceShader  = vantor::Resources::LoadShader("deferred irradiance", "res/intern/shaders/deferred/ambient_irradience.vs", "res/intern/shaders/deferred/ambient_irradience.fs");
        deferredDirectionalShader = vantor::Resources::LoadShader("deferred directional", "res/intern/shaders/deferred/screen_directional.vs", "res/intern/shaders/deferred/directional.fs");
