...
namespace vantor::Platform {
    ...
    Window::Window(int& success, bool FullScreen, unsigned int scrW, unsigned int scrH, std::string name) : name(name) {
        ...
        */
            ...
            this->window = SDL_CreateWindow(name.c_str(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
	        ...
	        glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED); // TODO: Make this choosable
