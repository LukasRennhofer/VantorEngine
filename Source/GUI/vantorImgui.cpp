...
namespace vantor::GUI {
	 ...
	 */
	GUI::GUI(vantor::Platform::Window& window)
	{
		// GUI
		ImGui::CreateContext();
		ImGui::StyleColorsDark();
		ImGui_ImplSDL2_InitForOpenGL(window.getWindow(), vantor::Platform::Window::glContext);
	...
	void GUI::draw()
	{
			...
			vantor::Graphics::sceneElements& scene = *this->scene;

			for (vantor::Graphics::drawableObject* obj : subscribers) {
				obj->setGui();
			}
	...
	GUI & GUI::subscribe(vantor::Graphics::drawableObject * subscriber)
	{
