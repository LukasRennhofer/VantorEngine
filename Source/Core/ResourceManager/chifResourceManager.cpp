...
namespace chif::ResourceManager {
    ...
    LoadShader(const std::string& name,
        ...
        if (it != resourceMap.end()) {
            return std::static_pointer_cast<chif::Graphics::RenderDevice::Shader>(it->second.resource);
        }
        ...
        for (auto& [type, loader] : loaders) {
            ...
            if (shaderLoader) {
                ...
                if (shader) {
                    ...
                    return std::static_pointer_cast<chif::Graphics::RenderDevice::Shader>(shader);
                }
            }
        }
