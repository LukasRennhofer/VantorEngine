...
namespace chif::GUI::font {
    ...
    chif::Graphics::Renderer::Shader::Shader fontShader("fontShader");
    ...
    bool initFont() {
        ...
        glm::mat4 projection = glm::ortho(0.0f, static_cast<float>(chif::Platform::Window::SCR_WIDTH), 0.0f, static_cast<float>(chif::Platform::Window::SCR_HEIGHT));
        fontShader.use();
