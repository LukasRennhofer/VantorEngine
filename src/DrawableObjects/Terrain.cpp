...
namespace chif::terrain {
	...
	Terrain::Terrain(int gl)
	{
		...
		shad = new chif::Shader::Shader("TerrainTessShader");
		...
		textures[0] = chif::utils::TextureFromFile("sand.jpg", "resources");
		textures[1] = chif::utils::TextureFromFile("grass.jpg", "resources");
		textures[2] = chif::utils::TextureFromFile("rdiffuse.jpg", "resources");
		textures[3] = chif::utils::TextureFromFile("snow2.jpg", "resources");
		textures[4] = chif::utils::TextureFromFile("rnormal.jpg", "resources");
		textures[5] = chif::utils::TextureFromFile("terrainTexture.jpg", "resources");
