...
namespace chif::Render3D {
	...
	public:
		...
		chif::Buffer::FrameBufferObject const& getReflectionFBO() {
	...
	private:
		...
		float scale, height;
		chif::Buffer::FrameBufferObject * reflectionFBO;
		chif::Buffer::FrameBufferObject * refractionFBO;

		unsigned int dudvMap, normalMap;
		glm::mat4 modelMatrix;
		chif::Shader::Shader * shad;
		//Model * waterPlane;
	};
} // NAMESPACE CHIF::RENDER3D