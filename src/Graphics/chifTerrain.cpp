...
namespace chif::Graphics {
	...
	Terrain::Terrain(int gl)
	{
		...
		textures[0] = chif::Graphics::TextureFromFile("sand.jpg", "resources");
		textures[1] = chif::Graphics::TextureFromFile("grass.jpg", "resources");
		textures[2] = chif::Graphics::TextureFromFile("rdiffuse.jpg", "resources");
		textures[3] = chif::Graphics::TextureFromFile("snow2.jpg", "resources");
		textures[4] = chif::Graphics::TextureFromFile("rnormal.jpg", "resources");
		textures[5] = chif::Graphics::TextureFromFile("terrainTexture.jpg", "resources");
