...
using VDirectionalLightData = Vantor::Renderer::VDirectionalLightData;
using VSpotLightData = Vantor::Renderer::VSpotLightData;
using VAmbientLightData = Vantor::Renderer::VAmbientLightData;
