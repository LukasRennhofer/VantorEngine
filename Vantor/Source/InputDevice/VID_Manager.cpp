...
namespace Vantor::Input {
    void VInputManager::AddDevice(std::shared_ptr<VIInputDevice> device)
    {
        devices.push_back(device);
    }

    void VInputManager::MapAction(const std::string& actionName, const VInputButton& button)
    {
        actionMap[actionName].push_back(button);
    }
