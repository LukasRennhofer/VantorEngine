    ...
    int toVantor(const SDL_Scancode &key, const SDL_Keycode &keyk)
    {
        ...
        { // Individual scancode key conversion
            ...
            case SDL_SCANCODE_LSHIFT:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_LSHIFT;
            case SDL_SCANCODE_RSHIFT:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_RSHIFT;
            case SDL_SCANCODE_RETURN:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_ENTER;
            case SDL_SCANCODE_ESCAPE:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_ESCAPE;
            case SDL_SCANCODE_HOME:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_HOME;
            case SDL_SCANCODE_RCTRL:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_RCONTROL;
            case SDL_SCANCODE_LCTRL:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_LCONTROL;
            case SDL_SCANCODE_DELETE:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_DELETE;
            case SDL_SCANCODE_BACKSPACE:
                return Vantor::Platform::Input::KEYBOARD_BUTTON_BACKSPACE;
