...
namespace Vantor::RenderDevice
{
    ...
    class VOpenGLTexture : public VTexture
    {
        public:
            ...
            bool SetData(const void* data, size_t dataSize, uint32_t level = 0, 
                        VTextureDataType dataType = VTextureDataType::UnsignedByte) override;
            bool SetSubData(const void* data, size_t dataSize, 
                           uint32_t x, uint32_t y, uint32_t width, uint32_t height,
                           uint32_t level = 0, VTextureDataType dataType = VTextureDataType::UnsignedByte) override;
    ...
    class VOpenGLTexture2D : public VOpenGLTexture
    {
        public:
            ...
            static std::shared_ptr<VOpenGLTexture2D> CreateFromFile(const std::string& filePath, 
                                                                  const VTextureSampler& sampler = {},
                                                                  bool generateMipmaps = true);
            static std::shared_ptr<VOpenGLTexture2D> CreateFromMemory(const void* data, uint32_t width, uint32_t height,
                                                                    VTextureFormat format = VTextureFormat::RGBA8,
                                                                    const VTextureSampler& sampler = {});
            static std::shared_ptr<VOpenGLTexture2D> CreateEmpty(uint32_t width, uint32_t height,
                                                               VTextureFormat format = VTextureFormat::RGBA8,
                                                               const VTextureSampler& sampler = {});
    ...
    class VOpenGLTextureCube : public VOpenGLTexture
    {
        public:
            ...
            bool SetFaceData(uint32_t face, const void* data, size_t dataSize,
                           uint32_t level = 0, VTextureDataType dataType = VTextureDataType::UnsignedByte);

            // VTextureCube static creation methods implementation
            static std::shared_ptr<VOpenGLTextureCube> CreateFromFiles(const std::string faceFiles[6],
                                                                     const VTextureSampler& sampler = {});
