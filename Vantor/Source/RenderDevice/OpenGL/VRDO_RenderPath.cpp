...
namespace Vantor::RenderDevice
{
    ...
    void VGeometryRenderPassGL::Initialize(VRenderPath3D *renderPath) { m_RenderPath = renderPath; }
    ...
    void VLightingRenderPassGL::Initialize(VRenderPath3D *renderPath)
    {
        ...
        auto ResShaderLighting = Vantor::Resource::VResourceManager::Instance().LoadShaderProgram(
            "VIShaderLighting", "Shaders/Private/Deffered/VLighting.vglsl", "Shaders/Private/Deffered/VLighting.fglsl");
    ...
    void VRenderPath3DGL::Initialize(VRDevice *device)
    {
        ...
        VRenderTargetDescriptor gBufferDesc = VRenderTargetUtils::CreateMRTTarget(m_ViewportWidth, m_ViewportHeight, //  TODO: work with resizing
                                                                                  {
    ...
    void VRenderPath3DGL::SetCamera(Vantor::Renderer::Camera *camera) { m_Camera = camera; }
