...
namespace Vantor::RenderDevice {
    ...
    namespace RenderTargetFactory
    {
        std::unique_ptr<VOpenGLRenderTarget> CreateColorTarget(uint32_t width, uint32_t height, 
                                                              ...
                                                              const std::string& debugName = "ColorTarget");
        ...
        std::unique_ptr<VOpenGLRenderTarget> CreateHDRTarget(uint32_t width, uint32_t height,
                                                            VTextureFormat hdrFormat = VTextureFormat::RGBA16F,
                                                            const std::string& debugName = "HDRTarget");

        std::unique_ptr<VOpenGLRenderTarget> CreateShadowMapTarget(uint32_t size = 1024,
                                                                  VTextureFormat depthFormat = VTextureFormat::Depth24,
                                                                  const std::string& debugName = "ShadowMap");
    }
