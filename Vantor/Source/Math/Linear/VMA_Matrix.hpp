...
struct VMat4 {
    ...
    static constexpr VMat4 Identity() noexcept {
        VMat4 mat{};
        mat.m[0] = 1.f;  mat.m[5] = 1.f;  mat.m[10] = 1.f;  mat.m[15] = 1.f;
        return mat;
    }
    ...
    static VMat4 RotationYawPitch(float yawDegrees, float pitchDegrees) noexcept {
        return RotationYaw(yawDegrees) * RotationPitch(pitchDegrees);
    }
...
struct VMat3 {
    ...
    static constexpr VMat3 Identity() noexcept {
        VMat3 mat{};
        mat.m[0] = 1.f; mat.m[4] = 1.f; mat.m[8] = 1.f;
        return mat;
    }
    ...
    static VMat3 LookAt(const VVector3& eye, const VVector3& center, const VVector3& up) noexcept {
        ...
        mat.m[3] = u.x;  mat.m[4] = u.y;  mat.m[5] = u.z;
        mat.m[6] = -f.x; mat.m[7] = -f.y; mat.m[8] = -f.z;
...
struct VMat2 {
    ...
    VVector2 operator*(const VVector2& vec) const noexcept {
        return {
            m[0] * vec.x + m[2] * vec.y,
            m[1] * vec.x + m[3] * vec.y
        };
