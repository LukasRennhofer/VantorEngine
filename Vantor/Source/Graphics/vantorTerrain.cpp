 ...
 *  Date: 2025-05-12
 *
 *  File: vantorTerrain.cpp
 *  Last Change: Automatically updated
 */

#include "vantorTerrain.h"
...
namespace vantor::Graphics
{
    ...
    Terrain::Terrain(int gl)
    {
        ...
        shad = new vantor::Graphics::Renderer::Shader::Shader("TerrainTessShader");
        ...
        textures[0]    = vantor::Graphics::TextureFromFile("sand.jpg", "resources");
        textures[1]    = vantor::Graphics::TextureFromFile("grass.jpg", "resources");
        textures[2]    = vantor::Graphics::TextureFromFile("rdiffuse.jpg", "resources");
        textures[3]    = vantor::Graphics::TextureFromFile("snow2.jpg", "resources");
        textures[4]    = vantor::Graphics::TextureFromFile("rnormal.jpg", "resources");
        textures[5]    = vantor::Graphics::TextureFromFile("terrainTexture.jpg", "resources");
    ...
    bool Terrain::getWhichTileCameraIs(glm::vec2 &result)
    {
        ...
        for (glm::vec2 p : positionVec)
        {
            ...
            {
                // std::cout << "You're in Tile: " << p.x << ", " << p.y <<
                // std::endl;
                result = p;
                return true;
            }
    ...
    void Terrain::setGui()
    {
        ...
        // ImGui::Checkbox("Clouds PostProc + God Rays",
        // this->getPostProcPointer());
        ...
        // ImGui::ColorEdit3("Cloud color", (float*)cloudBottomColor); // Edit 3
        // floats representing a color

        // ImGui::TextColored(ImVec4(1, 1, 0, 1), "Sky controls");
        ImGui::ColorEdit3("Rock color",
                          (float *) &rockColor[0]); // Edit 3 floats representing a color
        // ImGui::ColorEdit3("Sky bottom color",
        // (float*)this->getSkyBottomColorPtr()); // Edit 3 floats representing
        // a color
        ImGui::End();
    }
    ...
    bool Terrain::inTile(const Camera camera, glm::vec2 pos)
    {
        ...
        if (result)
        {
            ...
            // std::cout << y + scaleFactor * tileW / 2.0f << ": y +
            // scalefactor" << std::endl; std::cout << y - scaleFactor * tileW
            // / 2.0f << ": y - scalefactor" << std::endl;
        }
