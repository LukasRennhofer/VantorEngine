...
namespace vantor::Graphics
{
    Skybox::Skybox()
    {
        ...
        skyboxShader = new vantor::Graphics::Renderer::Shader::ScreenSpaceShader("shaders\\sky.frag");
        skyboxFBO    = new vantor::Graphics::Renderer::Buffer::FrameBufferObject(vantor::Platform::Window::SCR_WIDTH, vantor::Platform::Window::SCR_HEIGHT);
    ...
    void Skybox::draw()
    {
        vantor::Graphics::sceneElements *s = vantor::Graphics::drawableObject::scene;
        skyboxFBO->bind();

        vantor::Graphics::Renderer::Shader::Shader &shader = skyboxShader->getShader();
        shader.use();

        shader.setVec2("resolution", glm::vec2(vantor::Platform::Window::SCR_WIDTH, vantor::Platform::Window::SCR_HEIGHT));
