 ...
 *  Last Change: Created new simplified Resource Manager implementation
 */
...
namespace Vantor::Resource
{
    ...
    bool VResourceManager::Initialize()
    {
        ...
        Vantor::Backlog::Log("VResourceManager", "Resource Manager initialized successfully", 
    ...
    void VResourceManager::Shutdown()
    {
        ...
        Vantor::Backlog::Log("VResourceManager", "Resource Manager shut down", 
                           Vantor::Backlog::LogLevel::INFO);
    }
    
    std::shared_ptr<VTexture2DResource> VResourceManager::LoadTexture2D(
        const VResourceHandle& handle, 
    ...
    )
    {
        if (!m_initialized)
        {
            Vantor::Backlog::Log("VResourceManager", "Resource Manager not initialized", 
        ...
        {
            Vantor::Backlog::Log("VResourceManager", "Texture file not found: " + filePath, 
                               Vantor::Backlog::LogLevel::ERR);
            return nullptr;
        }
        ...
        try
        {
            ...
            if (!renderTexture)
            {
                Vantor::Backlog::Log("VResourceManager", "Failed to create texture object", 
                                   Vantor::Backlog::LogLevel::ERR);
            }
            ...
            Vantor::Backlog::Log("VResourceManager", "Texture loaded: " + handle + " (" + filePath + ")", 
                               Vantor::Backlog::LogLevel::INFO);
        ...
        {
            Vantor::Backlog::Log("VResourceManager", "Exception loading texture " + filePath + ": " + e.what(), 
                               Vantor::Backlog::LogLevel::ERR);
            return nullptr;
        }
    }
    
    std::shared_ptr<VShaderProgramResource> VResourceManager::LoadShaderProgram(const VResourceHandle& handle,
                                                                               ...
                                                                               const std::string& fragmentPath)
    {
        ...
        {
            Vantor::Backlog::Log("VResourceManager", "Vertex shader file not found: " + vertexPath, 
                               Vantor::Backlog::LogLevel::ERR);
            return nullptr;
        }
        ...
        {
            Vantor::Backlog::Log("VResourceManager", "Fragment shader file not found: " + fragmentPath, 
                               Vantor::Backlog::LogLevel::ERR);
            return nullptr;
        }
        ...
        try
        {
            ...
            {
                Vantor::Backlog::Log("VResourceManager", "Failed to read vertex shader: " + vertexPath, 
                                   Vantor::Backlog::LogLevel::ERR);
                return nullptr;
            }
            ...
            {
                Vantor::Backlog::Log("VResourceManager", "Failed to read fragment shader: " + fragmentPath, 
                                   Vantor::Backlog::LogLevel::ERR);
                return nullptr;
            }
            ...
            if (!renderShader)
            {
                Vantor::Backlog::Log("VResourceManager", "Failed to create shader object", 
                                   Vantor::Backlog::LogLevel::ERR);
                return nullptr;
            }
            ...
            Vantor::Backlog::Log("VResourceManager", "Shader program loaded: " + handle + " (" + 
        ...
        {
            Vantor::Backlog::Log("VResourceManager", "Exception loading shader program: " + std::string(e.what()), 
                               Vantor::Backlog::LogLevel::ERR);
            return nullptr;
        }
    }
    ...
    bool VResourceManager::UnloadResource(const VResourceHandle& handle)
    {
        ...
        Vantor::Backlog::Log("VResourceManager", "Resource unloaded: " + handle, 
                           Vantor::Backlog::LogLevel::INFO);
    ...
    void VResourceManager::UnloadAllResources()
    {
        ...
        if (count > 0)
        {
            Vantor::Backlog::Log("VResourceManager", "Unloaded " + std::to_string(count) + " resources", 
                               Vantor::Backlog::LogLevel::INFO);
        }
    }
    ...
    bool VResourceManager::ReloadResource(const VResourceHandle& handle)
    {
        ...
        Vantor::Backlog::Log("VResourceManager", "Resource reload requested: " + handle, 
                           Vantor::Backlog::LogLevel::INFO);
    ...
    bool VResourceManager::FileExists(const std::string& path) const
    {
        return Platform::Environment::FileExists(path);
    }
